...
import ServicePanel from './components/ServicePanel1.vue'
import type {
  SkuPopupEvent,
    ...
    <view class="goods">
      ...
      <view class="preview">
        <swiper @change="onChange" circular>
          <swiper-item v-for="item in goods?.mainPictures" :key="item">
            <image @tap="($event) => onTapimage(item)" mode="aspectFill" :src="item" />
          </swiper-item>
        </swiper>
      ...
      <view class="action">
        ...
        <view @tap="openPopup('address')" class="item arrow">
          ...
          <text class="text ellipsis" v-if="selecteAddress"
